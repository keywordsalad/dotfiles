...
local theme_path = gfs.get_configuration_dir().."themes/spaceburger"
...
-- overriding the spaceburger one when
...
theme.wallpaper = theme_path.."astronomical-object.png"
